...
| 프로젝트 | 설명 |
|----------|------|
| **세이브잇 SaveIt** (2025.04~) | 음식물 쓰레기 절감을 위한 마감 할인 예약 플랫폼 개발 (총괄)<br>📌 *2025 ICT 한이음 드림업 프로젝트 선정* |
| **아웃메이트 Outmate** (2024.04~11) | 외출도우미 앱 개발 (프론트 총괄)<br>📌 *2024 과기정통부 한이음 ICT 멘토링* 수행 |
